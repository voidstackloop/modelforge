...
export const en: Dictionary = {
    ...
    gpuLayersAuto: "Auto",
    gpuLayersHelp: "GPU offload for local GGUF models. Auto reserves VRAM for the selected context; 0 forces CPU-only, and a positive number sets a manual layer count.",
    seed: "Seed",
    seedRandom: "Random",
...
export const tr: Dictionary = {
    ...
    gpuLayersHelp: "Yerel GGUF modelleri için GPU aktarımı. Otomatik mod seçilen bağlam için VRAM ayırır; 0 yalnızca CPU'yu zorlar, pozitif değer manuel katman sayısını belirler.",
    seed: "Seed",
    seedRandom: "Rastgele",
